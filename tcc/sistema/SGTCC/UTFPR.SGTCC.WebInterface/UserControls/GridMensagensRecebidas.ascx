<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="GridMensagensRecebidas.ascx.vb" Inherits="UTFPR.SGTCC.WebInterface.GridMensagensRecebidas" %>

<asp:GridView ID="gdvMensagensRecebidas" runat="server" CellPadding="2" CellSpacing="1"
...
AllowPaging="True" PageSize="10" >
    ...
    <Columns>
       ...
       <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Autor">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Assunto">
            <ItemTemplate>
                <asp:LinkButton ID="btnVerMensagemRec" runat="server" 
                Text='<%# eval("Assunto") %>'
...
<div id="divAviso" style="width: 100%; text-align: center;" visible="false" runat="server">
